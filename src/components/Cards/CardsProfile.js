...
export default function CardProfile() {
    ...
    getUsers(token)
      .then((result) => {
        ...
        setcurrentLocation({
          ...
          lng: respon.additional_data.address.longitude})
        setFormProfil({
          full_name: respon.user.first_name+" "+respon.user.last_name,
        ...
        setaddress(respon.additional_data.address.full_address)
  ...
  const handleSubmit = async (event) => {
    ...
    let x = document.getElementById("norek").value;
    let y = document.getElementById("deskripsi").value;
    let z = document.getElementById("alamat").value;

    if (x == "") {
      alert("NO REKENING must be filled out");
      return false;
    } else if (y == "") {
      alert("TENTANG SAYA must be filled out");
      return false;
    } else if (z == "") {
      ...
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
        ...
        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                      ...
                      return (
                        <div className="flex flex-wrap gap-2" key={key}>
                          <div className="h-24 flex items-center justify-between rounded bg-gray-600 p-3 bg-white mt-2 ml-2">
                            ...
                            <div
                              onClick={() => {
                                handleRemoveProfil(key, "");
                              }}
                              className="h-8 w-8 bg-red-400 flex items-center cursor-pointer justify-center rounded-sm ml-3"
                            >
                              <BiTrash
            ...
            <div className="flex flex-wrap">
              ...
              <div className="w-full lg:w-12/12 px-4">
                <MapExample
                  props={currentLocation?currentLocation:{lat:0,lng:0}}
                    ...
                    >
                      {filesWedding.map((file, key) => {
                        return (
                          <div
                            key={key}
                            className="h-24 flex items-center justify-between rounded bg-gray-600 p-3 bg-white mt-2 ml-2"
                          >
                            <div className="flex flex-row items-center gap-2">
                              <div className="h-20 w-20">
                                <img
                            ...
                            <div
                              onClick={() => {
                                removeImage(file.id, "wedding");
                              }}
                              className="ml-3 h-8 w-8 bg-red-400 flex items-center cursor-pointer justify-center rounded-sm"
                            >
                              <BiTrash
                                className="mdi mdi-trash-can text-white text-[14px]"
                                size={20}
                      ...
                      {fileGraduation.map((file, key) => {
                        return (
                          ...
                          >
                            ...
                            <div
                              onClick={() => {
                                removeImage(file.id, "graduation");
                              }}
                              className="ml-3 h-8 w-8 bg-red-400 flex items-center cursor-pointer justify-center rounded-sm"
                            >
                              <BiTrash
